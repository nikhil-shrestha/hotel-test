...
class ExtraControllerSpec extends Specification implements ControllerUnitTest<ExtraController>, DomainUnitTest<Extra> {
    ...
    void "Test the index action returns the correct model"() {
        given:
        controller.extraService = Mock(ExtraDataService) {
            1 * list(_) >> []
            1 * count() >> 0
        }
    ...
    void "Test the save action correctly persists"() {
        ...
        controller.save(extra)

        then:"A redirect is issued to the show action"
        response.redirectedUrl == '/extra/show/1'
